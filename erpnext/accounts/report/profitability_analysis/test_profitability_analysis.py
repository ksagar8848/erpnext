...
class TestProfitabilityAnalysis(FrappeTestCase):
    ...
    def test_execute_with_cost_center(self):
    ...
    def test_execute_with_project(self):
        from erpnext.accounts.utils import get_fiscal_year
    ...
    def test_execute_with_accounting_dimension_validation(self):
        filters = _dict({
    ...
    def test_set_gl_entries_by_account(self):
    ...
    def test_calculate_and_accumulate(self):
        accounts = [_dict({
